    ...
    <Wrapper ref={ref} {...bind}>
      <div
        ...
        <div className="shapes"
            style={{
            transform: `
            translateX(${centerY/2.5}px)
            translateY(${centerX/2.5}px)
            `
            }}
        >
          <div className="shape" />
        ...
        <img
          ...
          style={{
            transform: `
            translateX(${centerY/3}px)
            translateY(${centerX/3}px)
            `
            }}
        />
        ...
        style={{
            transform: `
            translateX(${centerY/5}px)
            translateY(${centerX/5}px)
            `
            }}
        />
        ...
        style={{
            transform: `
            translateX(${centerY/6}px)
            translateY(${centerX/6}px)
            `
            }}/>
        ...
        style={{
            transform: `
            translateX(${centerY/8}px)
            translateY(${centerX/8}px)
            `
            }}/>
        ...
        <img
          ...
          style={{
            transform: `
            translateX(${centerY/7}px)
            translateY(${centerX/7}px)
            `
            }}
        />
      </div>
